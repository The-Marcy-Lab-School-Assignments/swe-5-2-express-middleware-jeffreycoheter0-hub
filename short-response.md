...
**Your answer here**:
Express is described as wrapping `node:http` because express is built on top of the `node:http` module and provides simpler request, response and routing. With `node:http`, you manually 
